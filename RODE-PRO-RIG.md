...
> route and mute the mics on their rows (mute the lapel to leave it out; the priority mic itself is
> chosen once in Settings), and switch to **Singing** for worship. "No new scenes are needed" below became "no scenes at all".
