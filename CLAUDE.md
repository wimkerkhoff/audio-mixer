...
│   └── OutputViewModel.cs    # Per-output: device, meter, volume, record button, automix mode + strength + quality-weighting
├── Models/
│   └── MixerPreset.cs        # Serializable: device IDs, volumes, mutes, delays, routes, automix mode/strength/quality-weighting
├── Services/
